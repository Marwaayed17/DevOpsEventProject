...
class EventServiceImplTest {
    ...
    void setUp() {
        ...
        participant = new Participant(1, "marwa", "ayed", INVITE, null);


        p1 = new Participant(1, "ayed", "marwa", INVITE, null);
        p2 = new Participant(2, "ben foulena", "foulena", ORGANISATEUR, null);
